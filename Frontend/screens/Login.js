  ...
  return (
    <AnimatedGradient>
      ...
      <View style={styles.card}>
        ...
        <TouchableOpacity style={styles.submit} onPress={submit} disabled={loading}><Text style={styles.submitText}>{loading ? 'Please wait...' : 'Login'}</Text></TouchableOpacity>
        <TouchableOpacity style={styles.alt} onPress={() => navigation.navigate('Signup')}><Text style={styles.altText}>Create an account</Text></TouchableOpacity>
      </View>
    </AnimatedGradient>
  )
}
